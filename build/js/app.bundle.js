...
/*!*****************************************************!*\
  ...
  \*****************************************************/
/*! no static exports found */function(e,o,s){"use strict";var r=s(/*! ./_global */"../node_modules/core-js/modules/_global.js"),t=s(/*! ./_has */"../node_modules/core-js/modules/_has.js"),n=s(/*! ./_descriptors */"../node_modules/core-js/modules/_descriptors.js"),u=s(/*! ./_export */"../node_modules/core-js/modules/_export.js"),d=s(/*! ./_redefine */"../node_modules/core-js/modules/_redefine.js"),l=s(/*! ./_meta */"../node_modules/core-js/modules/_meta.js").KEY,c=s(/*! ./_fails */"../node_modules/core-js/modules/_fails.js"),i=s(/*! ./_shared */"../node_modules/core-js/modules/_shared.js"),m=s(/*! ./_set-to-string-tag */"../node_modules/core-js/modules/_set-to-string-tag.js"),j=s(/*! ./_uid */"../node_modules/core-js/modules/_uid.js"),a=s(/*! ./_wks */"../node_modules/core-js/modules/_wks.js"),_=s(/*! ./_wks-ext */"../node_modules/core-js/modules/_wks-ext.js"),f=s(/*! ./_wks-define */"../node_modules/core-js/modules/_wks-define.js"),p=s(/*! ./_enum-keys */"../node_modules/core-js/modules/_enum-keys.js"),h=s(/*! ./_is-array */"../node_modules/core-js/modules/_is-array.js"),v=s(/*! ./_an-object */"../node_modules/core-js/modules/_an-object.js"),g=s(/*! ./_is-object */"../node_modules/core-js/modules/_is-object.js"),y=s(/*! ./_to-iobject */"../node_modules/core-js/modules/_to-iobject.js"),b=s(/*! ./_to-primitive */"../node_modules/core-js/modules/_to-primitive.js"),x=s(/*! ./_property-desc */"../node_modules/core-js/modules/_property-desc.js"),w=s(/*! ./_object-create */"../node_modules/core-js/modules/_object-create.js"),S=s(/*! ./_object-gopn-ext */"../node_modules/core-js/modules/_object-gopn-ext.js"),k=s(/*! ./_object-gopd */"../node_modules/core-js/modules/_object-gopd.js"),E=s(/*! ./_object-dp */"../node_modules/core-js/modules/_object-dp.js"),O=s(/*! ./_object-keys */"../node_modules/core-js/modules/_object-keys.js"),M=k.f,P=E.f,F=S.f,A=r.Symbol,N=r.JSON,I=N&&N.stringify,L=a("_hidden"),T=a("toPrimitive"),R={}.propertyIsEnumerable,D=i("symbol-registry"),W=i("symbols"),C=i("op-symbols"),G=Object.prototype,U="function"==typeof A,V=r.QObject,B=!V||!V.prototype||!V.prototype.findChild,z=n&&c(function(){return 7!=w(P({},"a",{get:function(){return P(this,"a",{value:7}).a}})).a})?function(e,o,s){var r=M(G,o);r&&delete G[o],P(e,o,s),r&&e!==G&&P(G,o,r)}:P,q=function(e){var o=W[e]=w(A.prototype);return o._k=e,o},Y=U&&"symbol"==typeof A.iterator?function(e){return"symbol"==typeof e}:function(e){return e instanceof A},J=function(e,o,s){return e===G&&J(C,o,s),v(e),o=b(o,!0),v(s),t(W,o)?(s.enumerable?(t(e,L)&&e[L][o]&&(e[L][o]=!1),s=w(s,{enumerable:x(0,!1)})):(t(e,L)||P(e,L,x(1,{})),e[L][o]=!0),z(e,o,s)):P(e,o,s)},K=function(e,o){v(e);for(var s,r=p(o=y(o)),t=0,n=r.length;n>t;)J(e,s=r[t++],o[s]);return e},H=function(e){var o=R.call(this,e=b(e,!0));return!(this===G&&t(W,e)&&!t(C,e))&&(!(o||!t(this,e)||!t(W,e)||t(this,L)&&this[L][e])||o)},X=function(e,o){if(e=y(e),o=b(o,!0),e!==G||!t(W,o)||t(C,o)){var s=M(e,o);return!s||!t(W,o)||t(e,L)&&e[L][o]||(s.enumerable=!0),s}},$=function(e){for(var o,s=F(y(e)),r=[],n=0;s.length>n;)t(W,o=s[n++])||o==L||o==l||r.push(o);return r},Z=function(e){for(var o,s=e===G,r=F(s?C:y(e)),n=[],u=0;r.length>u;)!t(W,o=r[u++])||s&&!t(G,o)||n.push(W[o]);return n};U||(d((A=function(){if(this instanceof A)throw TypeError("Symbol is not a constructor!");var e=j(arguments.length>0?arguments[0]:void 0),o=function(s){this===G&&o.call(C,s),t(this,L)&&t(this[L],e)&&(this[L][e]=!1),z(this,e,x(1,s))};return n&&B&&z(G,e,{configurable:!0,set:o}),q(e)}).prototype,"toString",function(){return this._k}),k.f=X,E.f=J,s(/*! ./_object-gopn */"../node_modules/core-js/modules/_object-gopn.js").f=S.f=$,s(/*! ./_object-pie */"../node_modules/core-js/modules/_object-pie.js").f=H,s(/*! ./_object-gops */"../node_modules/core-js/modules/_object-gops.js").f=Z,n&&!s(/*! ./_library */"../node_modules/core-js/modules/_library.js")&&d(G,"propertyIsEnumerable",H,!0),_.f=function(e){return q(a(e))}),u(u.G+u.W+u.F*!U,{Symbol:A});for(var Q="hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","),ee=0;Q.length>ee;)a(Q[ee++]);for(var oe=O(a.store),se=0;oe.length>se;)f(oe[se++]);u(u.S+u.F*!U,"Symbol",{for:function(e){return t(D,e+="")?D[e]:D[e]=A(e)},keyFor:function(e){if(!Y(e))throw TypeError(e+" is not a symbol!");for(var o in D)if(D[o]===e)return o},useSetter:function(){B=!0},useSimple:function(){B=!1}}),u(u.S+u.F*!U,"Object",{create:function(e,o){return void 0===o?w(e):K(w(e),o)},defineProperty:J,defineProperties:K,getOwnPropertyDescriptor:X,getOwnPropertyNames:$,getOwnPropertySymbols:Z}),N&&u(u.S+u.F*(!U||c(function(){var e=A();return"[null]"!=I([e])||"{}"!=I({a:e})||"{}"!=I(Object(e))})),"JSON",{stringify:function(e){for(var o,s,r=[e],t=1;arguments.length>t;)r.push(arguments[t++]);if(s=o=r[1],(g(o)||void 0!==e)&&!Y(e))return h(o)||(o=function(e,o){if("function"==typeof s&&(o=s.call(this,e,o)),!Y(o))return o}),r[1]=o,I.apply(N,r)}}),A.prototype[T]||s(/*! ./_hide */"../node_modules/core-js/modules/_hide.js")(A.prototype,T,A.prototype.valueOf),m(A,"Symbol"),m(Math,"Math",!0),m(r.JSON,"JSON",!0)},"../node_modules/core-js/modules/es6.typed.array-buffer.js":
/*!*****************************************************************!*\
...
/*!*************************!*\
  !*** ../src/js/main.js ***!
  \*************************/
/*! no static exports found */function(e,o,s){"use strict";document.addEventListener("DOMContentLoaded",function(){var e=document.querySelector(".hamburger-display"),o=document.querySelector(".small-menu"),s=document.querySelector("#cross"),r=document.querySelector("#main"),t=document.querySelectorAll(".hamburger-link");e.addEventListener("click",function(){o.classList.toggle("hamburger-menu"),e.classList.toggle("hamburger-display-none"),o.classList.toggle("small-menu"),r.style.display="none"}),s.addEventListener("click",function(){o.classList.toggle("hamburger-menu"),e.classList.toggle("hamburger-display-none"),o.classList.toggle("small-menu"),r.style.display="block"});for(var n=0;n<t.length;n++)t[n].addEventListener("click",function(){r.style.display="block",o.classList.toggle("hamburger-menu"),e.classList.toggle("hamburger-display-none"),o.classList.toggle("small-menu")})})},0:
/*!**********************************************!*\
